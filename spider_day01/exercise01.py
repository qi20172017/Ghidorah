...
<link rel="stylesheet" href="//s3plus.meituan.net/v1/mss_e2821d7f0cfe4ac1bf9202ecf9590e67/cdn-prod/file:5788b470/board-index.92a06072.css"/>
  ...
  <style>
    @font-face {
      ...
      src: url('//vfile.meituan.net/colorstone/e4ee9f593406cee81ae2fcc4571a18db3408.eot');
      src: url('//vfile.meituan.net/colorstone/e4ee9f593406cee81ae2fcc4571a18db3408.eot?#iefix') format('embedded-opentype'),
           url('//vfile.meituan.net/colorstone/2d154cd3193c8a4c7a429668cd07067e2276.woff') format('woff');
    }
...
<div class="header">
  <div class="header-inner">
        ...
        <div class="city-container" data-val="{currentcityid:60 }">
            ...
            <div class="city-list" data-val="{ localcityid: 60 }">
                <div class="city-list-header">定位城市：<a class="js-geo-city">青岛</a></div>
...
<div class="content">
    <div class="wrapper">
        <div class="main">
            <p class="update-time">2020-02-18<span class="has-fresh-text">已更新</span></p>
